  ...
  static void test_delete_reverse()
   {final int[]r = random_array();
    ...
    for (int i = r.length-1; i >= 0; --i)
     {ok(m.delete(m.key(r[i])).toInt(), m.data(i).toInt());
      if (!true)                                                                // Write case statement to check deletions
       {say("        case", i, "-> /*", r[i], "*/ ok(m.printHorizontally(), \"\"\"");
        say(m.printHorizontally());
        say("\"\"\");");
...
""");
        case 65 -> /* 72 */ ok(m.printHorizontally(), """
                                                                         317                                                                                              511                                                                                                                                                         |
                                          246                                                             403                                  472                                                            578                   658                                                     858                                       |
        103                186                           279                           358                           425            442                       501                       545        560                       650               686        704                806                               912 961                |
...
""");
        case 62 -> /* 516 */ ok(m.printHorizontally(), """
                                                                      317                                                                                          511                                                                                                                                                  |
                                       246                                                         403                                  472                                                     578                   658                                                     858                                       |
     103                186                           279                           358                       425            442                       501                   545                               650               686        704                806                               912 961                |
...
""");
        case 59 -> /* 809 */ ok(m.printHorizontally(), """
                                                                  317                                                                                      511                                                                                                                                           |
                                   246                                                         403                              472                                                                           658                                              858                                       |
     103                186                       279                           358                       425        442                       501                   545                578            650                       704                806                           912 961                |
...
""");
        case 52 -> /* 690 */ ok(m.printHorizontally(), """
                                                      317                                                                                  511                                                                                                                            |
                               246                                                 403                              472                                                                       658                               858                                       |
     103            186                   279                       358                       425        442                   501                   545                578            650                   704                                   912 961                |
...
""");
        case 51 -> /* 494 */ ok(m.printHorizontally(), """
                                                      317                                                                           511                                                                                                                            |
                               246                                                 403                              472                                                                658                               858                                       |
     103            186                   279                       358                       425        442                                  545                578            650                   704                                   912 961                |
...
""");
        case 48 -> /* 234 */ ok(m.printHorizontally(), """
                                           317                                                                           511                                                                                                                        |
                    246                                                 403                              472                                                                658                           858                                       |
             186               279                       358                       425        442                                  545                578            650               704                                   912 961                |
