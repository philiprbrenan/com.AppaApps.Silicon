...
//D1 Construction                                                               // Create a Btree from nodes which can be branches or leaves.  The data associated with the Btree is stored only in the leaves opposite the keys
  ...
  Mjaf2() {this(16, 16, 4, 1000);}                                              // Define a Btree with a minimal maximum number of keys per node

  static Mjaf2 mjaf2(int Key, int Data, int MaxKeysPerLeaf, int size)           // Define a Btree with a specified maximum number of keys per leaf.
  ...
  class BitString implements Comparable<BitString>                              // Definition of a key or data
   {final boolean[]bits;                                                        // Value of bit string
    ...
    public int compareTo(BitString B)
...
""");
  ...
  static void test_save()
   {final int N = 10;
    ...
    ok(nodes.elementAt(0) instanceof Mjaf2.Branch);
    ok(nodes.elementAt(1) instanceof Mjaf2.Leaf);
    ok(nodes.elementAt(2) instanceof Mjaf2.Leaf);
    ok(nodes.elementAt(3) instanceof Mjaf2.Leaf);
    //say(m.printHorizontally());
   }
